...
function __UnicDecimalInterrogate()
{
    ...
    var _foundDecimalFormats = ds_map_create();
    ...
    repeat(array_length(_namesArray))
    {
        ...
        _foundDecimalFormats[? _data.decimalFormat] = _name;
    
        ++_i;
    }
    
    var _valueArray = ds_map_keys_to_array(_foundDecimalFormats);
    ...
    ds_map_destroy(_foundDecimalFormats);
}